        ...
        Surface(
            ...
            Column(
                    ...
                    when (id) {
                        "name" -> {
                            OutlinedTextField(
                                ...
                                onValueChange = {
                                    temp = it
                                    error = UserValidators.validateName(it)
                                },
                                isError = error != null,
                                    ...
                                    .clickable(
                                        ...
                                        val datePicker = android.app.DatePickerDialog(
                                            ...
                                            { _, y, m, d ->
                                                ...
                                                temp = formatted
                                                error = UserValidators.validateBirthdate(
                                                    LocalDate.parse(
                                                        formatted,
                                                        formatter
                                                    )
                        ...
                        "gender" -> {
                            ...
                            Gender.entries.forEach { option ->
                                val isSelected = temp == option.label
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            val finalError = when (id) {
                                "name" -> UserValidators.validateName(temp)
                                "gender" -> if (temp.isBlank()) "Selecione" else null
                                "birthday" -> {
                                    try {
                                        ...
                                        UserValidators.validateBirthdate(date)
                                    } catch (e: Exception) {
                                        "Data inválida"
                                    }
                                }
