package com.example.cuidapet.ui.screens.pets.medicalrecords
...
@Composable
fun PetMedicalRecordRegisterScreen(
    navController: NavHostController,
    snackbarHostState: SnackbarHostState,
    scope: CoroutineScope,
    petId: String
) {
    PetMedicalRecordRegisterScreenContent(
...
@Composable
fun PetMedicalRecordRegisterScreenContent(
    navController: NavHostController,
    snackbarHostState: SnackbarHostState,
    scope: CoroutineScope,
